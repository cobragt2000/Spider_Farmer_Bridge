/*! spider-farmer-card v0.16.0 | MIT */
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pt={attribute:!0,type:String,converter:$,reflect:!1,hasChanged:x},ht=(t=pt,e,s)=>{const{kind:i,metadata:r}=s;let n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),"setter"===i&&((t=Object.create(t)).wrapped=!0),n.set(s.name,t),"accessor"===i){const{name:i}=s;return{set(s){const r=e.get.call(this);e.set.call(this,s),this.requestUpdate(i,r,t,!0,s)},init(e){return void 0!==e&&this.C(i,void 0,t,e),e}}}if("setter"===i){const{name:i}=s;return function(s){const r=this[i];e.call(this,s),this.requestUpdate(i,r,t,!0,s)}}throw Error("Unsupported decorator location: "+i)};function ut(t){return(e,s)=>"object"==typeof s?ht(t,e,s):((t,e,s)=>{const i=e.hasOwnProperty(s);return e.constructor.createProperty(s,t),i?Object.getOwnPropertyDescriptor(e,s):void 0})(t,e,s)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ft(t){return ut({...t,state:!0,attribute:!1})}const gt="#ff7a1a",vt=["S","M","T","W","T","F","S"],mt=/^sf_(dp\d+|ac5|ac10)_/;function bt(t){return t.split(".")[1]??""}function $t(t,e,s,i){const r=i*Math.PI/180;return[t+s*Math.cos(r),e+s*Math.sin(r)]}function xt(t,e,s,i,r){const n=135+270*i,a=135+270*r,[o,l]=$t(t,e,s,n),[c,d]=$t(t,e,s,a),p=a-n>180?1:0;return`M ${o.toFixed(2)} ${l.toFixed(2)} A ${s} ${s} 0 ${p} 1 ${c.toFixed(2)} ${d.toFixed(2)}`}function _t(t){const e=String(t),s=e.indexOf(".");return s>=0?e.length-s-1:0}function yt(t,e){return""===t||"unknown"===t||"unavailable"===t?"":Number.isFinite(Number(t))?Number(t).toFixed(_t(e)):t}function wt(t){const e=t.currentTarget,s=e.parentElement?.querySelector(".sl-bub");if(!s)return;const i=Number(e.min||"0"),r=Number(e.max||"100"),n=Number(e.value),a=r>i?(n-i)/(r-i):0,o=_t(Number(e.step||"1")),l=Number.isFinite(n)?n.toFixed(o):e.value;s.textContent="1"===e.dataset.off&&n<=i?"off":`${l}${e.dataset.unit??""}`,s.style.left=`calc(${a} * (100% - 18px) + 9px)`}const St=a`
  .sl-live {
...
`;function At(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(mt);t&&e.add(t[1])}return[...e].sort()}function kt(t){return At(t).filter(e=>Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function Ct(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function Et(t,e){const s=Ct(t,e);return s?t.entities?.[s]?.device_id:void 0}function Ot(t,e){if(!e)return[];const s=Et(t,e);return function(t){return At(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!0;if(!s)return!1;const r=Et(t,i),n=r?t.devices?.[r]:void 0;return n?.via_device_id===s})}function Nt(t,e){if(!t||!e)return"";const s=Ct(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,r=i?t.devices?.[i]:void 0;if(r)return r.name_by_user||r.name||"";const n=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return n?n[1]:""}const Pt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","VPD","mdi:water-opacity"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],zt=[["light_1","Light 1","mdi:lightbulb"],["light_2","Light 2","mdi:lightbulb"]],Dt=[["fan","Fan","mdi:fan"],["blower","Blower","mdi:weather-windy"]],Mt=[["heater","Heater","mdi:radiator"],["humidifier","Humidifier","mdi:air-humidifier"],["dehumidifier","Dehumidifier","mdi:air-humidifier-off"]],Rt=[["Temperature","env_temp_day","env_temp_night","env_temp_deadband","mdi:thermometer"],["Humidity","env_humi_day","env_humi_night","env_humi_deadband","mdi:water-percent"],["CO2","env_co2_day","env_co2_night","env_co2_deadband","mdi:molecule-co2"]];class Tt extends ct{constructor(){super(...arguments),this.tab="overview",this.alertsDraft=null,this.soilOpen=null,this.soilAllOpen=!1,this.deviceOpen=null,this.outletDraft={}}setConfig(t){if(!t.panel)throw new Error('spider-farmer-card: "panel" is required (e.g. panel: dp1)');this.config=t;const e=t.default_tab;this.tab="environment"===e||"config"===e?"env":"outlets"===e?"outlets":"calibration"===e||"cali"===e?"cali":"overview"}getCardSize(){return 8}static getConfigElement(){return document.createElement("spider-farmer-card-editor")}static getStubConfig(t){const e=(t?kt(t):[])[0]||"dp1",s=t?Ot(t,e):[];return{type:"custom:spider-farmer-card",panel:e,...s.length?{outlets:s}:{}}}eid(t,e){return`${t}.sf_${this.config.panel}_${e}`}get(t){return this.hass?.states[t]}accent(){return this.config.accent||gt}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("tab")||t.has("soilOpen")||t.has("soilAllOpen")||t.has("outletDraft")||t.has("alertsDraft")}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return J;const r=i.attributes.unit_of_measurement||"",n=this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(r,"").trim():i.state,a=t.startsWith("soil_avg_")?t.slice(9):null,o=!!a&&this.soilProbeRows(a).length>1,l=o&&this.soilOpen===a;return I`
      ...
      ${e?I`
            ...
            </div>`:J}`}overviewDevices(){const t=[],e=(e,s)=>{for(const[i,r,n]of s){const s=this.eid(e,i);this.get(s)&&t.push({domain:e,suffix:i,id:s,label:r,icon:n})}};return e("light",zt),e("fan",Dt),e("switch",Mt),t}deviceStateText(t,e){if("unavailable"===e.state||"unknown"===e.state)return"Offline";if("light"===t)return"on"!==e.state?"Off":`${Math.round((e.attributes.brightness??0)/255*100)}%`;if("fan"===t){if("on"!==e.state)return"Off";const t=Math.round(e.attributes.percentage??0);return t?`${t}%`:"On"}return"on"===e.state?"On":"Off"}deviceTile(t){const e=this.get(t.id);if(!e)return J;const s="on"===e.state,i=`${t.domain}:${t.suffix}`,r=this.deviceOpen===i,n=this.accent();return I`
      <div class="tile clickable ${r?"active":""}"
        style=${r?`box-shadow:inset 0 0 0 1px ${n}`:""}
        role="button" aria-expanded=${r?"true":"false"}
        @click=${()=>this.deviceOpen=r?null:i}>
      ...
      </div>`}relatedControls(t,e){const s=this.config.panel,i=new RegExp(`^(number|select|switch|text)\\.sf_${s}_${t}(_|$)`),r=`switch.sf_${s}_${t}`,n=`number.sf_${s}_${t}_speed`,a=Nt(this.hass,this.config.panel);return Object.keys(this.hass?.states??{}).filter(t=>i.test(t)&&t!==r&&!("fan"===e&&t===n)).sort().map(t=>{let e=this.hass?.states[t]?.attributes.friendly_name??"";return a&&e.startsWith(a)&&(e=e.slice(a.length).trim()),this.renderControl(t,e||void 0)})}renderDevicePop(){const t=this.deviceOpen;if(!t)return J;const e=this.overviewDevices().find(e=>`${e.domain}:${e.suffix}`===t);if(!e)return J;const s=this.get(e.id);if(!s)return J;const i="light"===e.domain?this.renderLightBody(e,s):this.renderGenericBody(e,s);return I`
      <div class="soil-pop">
        <div class="soil-pop-head">
          <span>${e.label}</span>
          <ha-icon icon="mdi:close" role="button" aria-label="Close"
            @click=${()=>this.deviceOpen=null}></ha-icon>
        </div>
        ${i}
      ...
      <div class="dev-row">
        ...
        </div>`}return I`${this.powerRow(t.id,r,t.label,s)}${n}${this.relatedControls(t.suffix,t.domain)}`}textState(t){const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""}durMinutes(t,e){const s=t=>{const e=/^(\d{1,2}):(\d{2})/.exec(t);return e?60*Number(e[1])+Number(e[2]):null},i=s(this.textState(t)),r=s(this.textState(e));if(null==i||null==r)return null;let n=(r-i+1440)%1440;return 0===n&&(n=1440),n}durationText(t,e){const s=this.durMinutes(t,e);return null==s?null:`${Math.floor(s/60)}h ${String(s%60).padStart(2,"0")}min`}infoRow(t,e){return I`<div class="dev-row">
      <span class="dev-lbl">${t}</span><span class="dev-spacer"></span>
      <span class="dev-val">${e}</span>
    </div>`}ctlRow(t,e){const s=this.get(e);if(!s)return J;const i=e.split(".")[0];let r;return r="number"===i?this.numberControl(e,s):"select"===i?this.selectControl(e,s):"text"===i?this.textControl(e,s):I`<span class="ctl-val">${s.state}</span>`,I`<div class="dev-row">
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${r}</div>
    </div>`}periodRow(t,e){const s=this.get(t),i=this.get(e);return s||i?I`<div class="dev-row">
      <span class="dev-lbl">Lighting period</span>
      <div class="period-times">
        ${s?this.textControl(t,s):J}
        <span class="dash">–</span>
        ${i?this.textControl(e,i):J}
      </div>
    </div>`:J}renderLightBody(t,e){const s=this.config.panel,i=t.suffix,r=this.accent(),n="on"===e.state,a=`select.sf_${s}_${i}_mode`,o=this.get(a),l=o?.state??"Manual",c=this.get(`sensor.sf_${s}_${i}_brightness`),d=this.get(`sensor.sf_${s}_ppfd`),p=c&&Number.isFinite(Number(c.state))?`${Math.round(Number(c.state))}%`:"—",h=d&&Number.isFinite(Number(d.state))?`${Math.round(Number(d.state))} µmol`:"—",u=[];if(o&&u.push(this.ctlRow("Mode",a)),u.push(this.powerRow(t.id,"light",t.label,n)),"Manual"===l){const s=Math.round((e.attributes.brightness??0)/255*100);u.push(I`
        <div class="dev-row">
        ...
        </div>`),u.push(this.infoRow("Current PPFD",h))}else if("Time Slot"===l){const t=`text.sf_${s}_${i}_schedule_start`,e=`text.sf_${s}_${i}_schedule_stop`;u.push(this.infoRow("Current",`${p} · ${h}`));const r=this.durationText(t,e);r&&u.push(this.infoRow("Light duration",r)),u.push(this.periodRow(t,e)),u.push(this.ctlRow("Target Brightness",`number.sf_${s}_${i}_schedule_brightness`)),u.push(this.ctlRow("Simulate Sunrise/Sunset",`number.sf_${s}_${i}_fade`)),u.push(this.ctlRow("Go dark",`number.sf_${s}_${i}_go_dark`)),u.push(this.ctlRow("Turn off",`number.sf_${s}_${i}_turn_off`))}else if("PPFD"===l){const t=`text.sf_${s}_${i}_ppfd_start`,e=`text.sf_${s}_${i}_ppfd_stop`,r=`number.sf_${s}_${i}_ppfd_target`;u.push(this.infoRow("Current",`${p} · ${h}`));const n=this.durationText(t,e),a=this.durMinutes(t,e),o=Number(this.get(r)?.state);if(n&&null!=a&&Number.isFinite(o)){const t=o*a*60/1e6;u.push(this.infoRow("DLI · duration",`${t.toFixed(2)} mol/m²/day · ${n}`))}else n&&u.push(this.infoRow("Light duration",n));u.push(this.periodRow(t,e));const l=this.get(r);u.push(I`<div class="dev-row">
        <span class="dev-lbl">Target PPFD</span>
        <div class="ctl-input">${l?this.numberControl(r,l):J}</div>
        <span class="dev-val" style="margin-left:8px" title="current">${h}</span>
      </div>`),u.push(this.ctlRow("Simulate Sunrise/Sunset",`number.sf_${s}_${i}_ppfd_fade`)),u.push(this.ctlRow("Go dark",`number.sf_${s}_${i}_go_dark`)),u.push(this.ctlRow("Turn off",`number.sf_${s}_${i}_turn_off`))}return u}setBrightness(t,e){const s=Number(e.target.value);s<=0?this.hass?.callService("light","turn_off",{entity_id:t}):this.hass?.callService("light","turn_on",{entity_id:t,brightness_pct:s})}setPercent(t,e){const s=Number(e.target.value);this.hass?.callService("fan","set_percentage",{entity_id:t,percentage:s})}renderOverview(){const t=Pt.map(t=>this.renderParam(t)).filter(t=>t!==J),e=this.overviewDevices();return I`
      ...
      ${Rt.map(([e,s,i,r,n])=>this.get(`number.sf_${t}_${s}`)?I`
          <div class="env-row">
      ...
      ${e.map((t,e)=>I`<div class="alert-bool">
        ...
        @click=${()=>this.tab=t}>${e}</button>`,l=Nt(this.hass,this.config.panel);return I`
      <ha-card>
        <div class="header">
    ...
    .period-times .dash { color: var(--secondary-text-color); }
  ...
  `,t([ut({attribute:!1})],Ut.prototype,"hass",void 0),t([ft()],Ut.prototype,"_config",void 0);const Ft=/^sf_(se\d+)_light$/;function jt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Ft);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Ht extends ct{constructor(){super(...arguments),this.draft=null}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?jt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||gt}seSlot(){return this.config.light||(this.hass?jt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")}setBrightness(t){const e=`light.sf_${this.seSlot()}_light`;t<=0?this.hass?.callService("light","turn_off",{entity_id:e}):this.hass?.callService("light","turn_on",{entity_id:e,brightness_pct:t})}toggle(){this.hass?.callService("light","toggle",{entity_id:`light.sf_${this.seSlot()}_light`})}setMode(t){this.hass?.callService("select","select_option",{entity_id:`select.sf_${this.seSlot()}_mode`,option:t})}render(){if(!this.hass||!this.config)return J;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return I`<ha-card>
        <div class="empty">
          No Spider Farmer SE light found${this.config.light?` for "${this.config.light}"`:""}.
        </div>
      </ha-card>`;const s="on"===e.state,i=s?Math.max(0,Math.min(100,Math.round((e.attributes.brightness??0)/255*100))):0,r=this.get(`select.sf_${t}_mode`),n=r?.state??"",a=Nt(this.hass,t),o=this.accent(),l=i/100,[c,d]=$t(100,100,78,135+270*l);return I`
      <ha-card>
        <div class="header">
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${s&&l>0?V`<path d=${xt(100,100,78,0,l)} fill="none"
    ...
    .save { color: #fff; }
    .discard { background: var(--secondary-background-color); color: var(--primary-text-color); }
  `,t([ut({attribute:!1})],Ht.prototype,"hass",void 0),t([ft()],Ht.prototype,"config",void 0),t([ft()],Ht.prototype,"draft",void 0),customElements.get("spider-farmer-card")||customElements.define("spider-farmer-card",Tt),customElements.get("spider-farmer-card-editor")||customElements.define("spider-farmer-card-editor",Ut),customElements.get("spider-light-card")||customElements.define("spider-light-card",Ht),window.customCards=window.customCards||[],window.customCards.push({type:"spider-farmer-card",name:"Spider Farmer Card",description:"Tent overview + config for the Spider Farmer Bridge integration",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),window.customCards.push({type:"spider-light-card",name:"Spider Light Card",description:"Brightness dial, mode, and schedule for a Spider Farmer SE-series light",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),console.info("%c SPIDER-FARMER-CARD %c v0.16.0 ","color:#fff;background:#ff7a1a;border-radius:3px 0 0 3px;padding:2px 4px","color:#ff7a1a;background:#222;border-radius:0 3px 3px 0;padding:2px 4px");export{Tt as SpiderFarmerCard,Ut as SpiderFarmerCardEditor,Ht as SpiderLightCard};
