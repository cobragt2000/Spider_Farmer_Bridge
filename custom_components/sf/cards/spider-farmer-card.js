 ...
 */function pt(t){return ht({...t,state:!0,attribute:!1})}const ut=/^sf_(dp\d+|ac5|ac10)_/;function ft(t){return t.split(".")[1]??""}function gt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=ft(s).match(ut);t&&e.add(t[1])}return[...e].sort()}function $t(t){return gt(t).filter(e=>Object.keys(t.states).some(t=>{const s=ft(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function mt(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>ft(t)===`sf_${e}_temperature`)??i.find(t=>{const i=ft(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function _t(t,e){const s=mt(t,e);return s?t.entities?.[s]?.device_id:void 0}function vt(t,e){if(!e)return[];const s=_t(t,e);return function(t){return gt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!0;if(!s)return!1;const r=_t(t,i),n=r?t.devices?.[r]:void 0;return n?.via_device_id===s})}function bt(t,e){if(!t||!e)return"";const s=mt(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,r=i?t.devices?.[i]:void 0;if(r)return r.name_by_user||r.name||"";const n=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return n?n[1]:""}const yt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","VPD","mdi:water-opacity"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],xt=[["light_1","Light 1","mdi:lightbulb"],["light_2","Light 2","mdi:lightbulb"]],wt=[["fan","Fan","mdi:fan"],["blower","Blower","mdi:weather-windy"]],At=[["heater","Heater","mdi:radiator"],["humidifier","Humidifier","mdi:air-humidifier"],["dehumidifier","Dehumidifier","mdi:air-humidifier-off"]],St=[["Temperature","env_temp_day","env_temp_night","env_temp_deadband","mdi:thermometer"],["Humidity","env_humi_day","env_humi_night","env_humi_deadband","mdi:water-percent"],["CO2","env_co2_day","env_co2_night","env_co2_deadband","mdi:molecule-co2"]];class Ct extends at{constructor(){super(...arguments),this.tab="overview"}setConfig(t){if(!t.panel)throw new Error('spider-farmer-card: "panel" is required (e.g. panel: dp1)');this.config=t;const e=t.default_tab;this.tab="environment"===e||"config"===e?"env":"outlets"===e?"outlets":"calibration"===e||"cali"===e?"cali":"overview"}getCardSize(){return 8}static getConfigElement(){return document.createElement("spider-farmer-card-editor")}static getStubConfig(t){const e=(t?$t(t):[])[0]||"dp1",s=t?vt(t,e):[];return{type:"custom:spider-farmer-card",panel:e,...s.length?{outlets:s}:{}}}eid(t,e){return`${t}.sf_${this.config.panel}_${e}`}get(t){return this.hass?.states[t]}accent(){return this.config.accent||"#ff7a1a"}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("tab")}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return q;const r=i.attributes.unit_of_measurement||"",n=this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(r,"").trim():i.state;return I`
      ...
      </div>`}renderFan([t,e,s]){const i=this.eid("fan",t),r=this.get(i);if(!r)return q;const n="on"===r.state,o=Math.round(r.attributes.percentage??0);return I`
      <div class="row">
        <ha-icon icon="${s}" style="color:${this.accent()}"></ha-icon>
        <div class="row-body">
          <div class="row-label">${e}</div>
      ...
      </div>`}renderClimate([t,e,s]){const i=this.eid("switch",t),r=this.get(i);if(!r)return q;const n="on"===r.state;return I`
      <div class="row">
        <ha-icon icon="${s}" style="color:${this.accent()}"></ha-icon>
      ...
      </div>`}numberControl(t,e){const s=e.attributes.min??0,i=e.attributes.max??100,r=e.attributes.step??1,n=e.attributes.unit_of_measurement??"",o="slider"===e.attributes.mode,a="unknown"===e.state||"unavailable"===e.state?"":e.state;return o?I`
      ...
      </div>`}render(){if(!this.hass||!this.config)return q;const t=this.hasEnv(),e=this.hasOutlets(),s=this.hasCali();let i=this.tab;"env"!==i||t||(i="overview"),"outlets"!==i||e||(i="overview"),"cali"!==i||s||(i="overview");const r=t||e||s,n=this.accent(),o=(t,e)=>I`<button class="tab ${i===t?"active":""}"
        style=${i===t?`color:${n};border-color:${n}`:""}
        @click=${()=>this.tab=t}>${e}</button>`,a=bt(this.hass,this.config.panel);return I`
      <ha-card>
        <div class="header">
