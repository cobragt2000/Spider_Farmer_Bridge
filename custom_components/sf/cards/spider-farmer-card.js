/*! spider-farmer-card v0.16.9 | MIT */
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,S=t=>t,k=w.trustedTypes,A=k?k.createPolicy("lit-html",{createHTML:t=>t}):void 0,O="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,E="?"+C,P=`<${E}>`,N=document,R=()=>N.createComment(""),D=t=>null===t||"object"!=typeof t&&"function"!=typeof t,M=Array.isArray,z="[ \t\n\f\r]",T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,F=/-->/g,j=/>/g,U=RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),B=/'/g,H=/"/g,L=/^(?:script|style|textarea|title)$/i,W=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),I=W(1),V=W(2),q=Symbol.for("lit-noChange"),J=Symbol.for("lit-nothing"),K=new WeakMap,G=N.createTreeWalker(N,129);function Z(t,e){if(!M(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==A?A.createHTML(e):e}const X=(t,e)=>{const s=t.length-1,i=[];let r,n=2===e?"<svg>":3===e?"<math>":"",a=T;for(let e=0;e<s;e++){const s=t[e];let o,l,c=-1,d=0;for(;d<s.length&&(a.lastIndex=d,l=a.exec(s),null!==l);)d=a.lastIndex,a===T?"!--"===l[1]?a=F:void 0!==l[1]?a=j:void 0!==l[2]?(L.test(l[2])&&(r=RegExp("</"+l[2],"g")),a=U):void 0!==l[3]&&(a=U):a===U?">"===l[0]?(a=r??T,c=-1):void 0===l[1]?c=-2:(c=a.lastIndex-l[2].length,o=l[1],a=void 0===l[3]?U:'"'===l[3]?H:B):a===H||a===B?a=U:a===F||a===j?a=T:(a=U,r=void 0);const p=a===U&&t[e+1].startsWith("/>")?" ":"";n+=a===T?s+P:c>=0?(i.push(o),s.slice(0,c)+O+s.slice(c)+C+p):s+C+(-2===c?e:p)}return[Z(t,n+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class Q{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let r=0,n=0;const a=t.length-1,o=this.parts,[l,c]=X(t,e);if(this.el=Q.createElement(l,s),G.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=G.nextNode())&&o.length<a;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(O)){const e=c[n++],s=i.getAttribute(t).split(C),a=/([.?@])?(.*)/.exec(e);o.push({type:1,index:r,name:a[2],strings:s,ctor:"."===a[1]?it:"?"===a[1]?rt:"@"===a[1]?nt:st}),i.removeAttribute(t)}else t.startsWith(C)&&(o.push({type:6,index:r}),i.removeAttribute(t));if(L.test(i.tagName)){const t=i.textContent.split(C),e=t.length-1;if(e>0){i.textContent=k?k.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],R()),G.nextNode(),o.push({type:2,index:++r});i.append(t[e],R())}}}else if(8===i.nodeType)if(i.data===E)o.push({type:2,index:r});else{let t=-1;for(;-1!==(t=i.data.indexOf(C,t+1));)o.push({type:7,index:r}),t+=C.length-1}r++}}static createElement(t,e){const s=N.createElement("template");return s.innerHTML=t,s}}function Y(t,e,s=t,i){if(e===q)return e;let r=void 0!==i?s._$Co?.[i]:s._$Cl;const n=D(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t),r._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=r:s._$Cl=r),void 0!==r&&(e=Y(t,r._$AS(t,e.values),r,i)),e}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??N).importNode(e,!0);G.currentNode=i;let r=G.nextNode(),n=0,a=0,o=s[0];for(;void 0!==o;){if(n===o.index){let e;2===o.type?e=new et(r,r.nextSibling,this,t):1===o.type?e=new o.ctor(r,o.name,o.strings,this,t):6===o.type&&(e=new at(r,this,t)),this._$AV.push(e),o=s[++a]}n!==o?.index&&(r=G.nextNode(),n++)}return G.currentNode=N,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class et{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=J,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Y(this,t,e),D(t)?t===J||null==t||""===t?(this._$AH!==J&&this._$AR(),this._$AH=J):t!==this._$AH&&t!==q&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>M(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==J&&D(this._$AH)?this._$AA.nextSibling.data=t:this.T(N.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=Q.createElement(Z(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new tt(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=K.get(t.strings);return void 0===e&&K.set(t.strings,e=new Q(t)),e}k(t){M(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const r of t)i===e.length?e.push(s=new et(this.O(R()),this.O(R()),this,this.options)):s=e[i],s._$AI(r),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=S(t).nextSibling;S(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class st{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,r){this.type=1,this._$AH=J,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=J}_$AI(t,e=this,s,i){const r=this.strings;let n=!1;if(void 0===r)t=Y(this,t,e,0),n=!D(t)||t!==this._$AH&&t!==q,n&&(this._$AH=t);else{const i=t;let a,o;for(t=r[0],a=0;a<r.length-1;a++)o=Y(this,i[s+a],e,a),o===q&&(o=this._$AH[a]),n||=!D(o)||o!==this._$AH[a],o===J?t=J:t!==J&&(t+=(o??"")+r[a+1]),this._$AH[a]=o}n&&!i&&this.j(t)}j(t){t===J?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class it extends st{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===J?void 0:t}}class rt extends st{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==J)}}class nt extends st{constructor(t,e,s,i,r){super(t,e,s,i,r),this.type=5}_$AI(t,e=this){if((t=Y(this,t,e,0)??J)===q)return;const s=this._$AH,i=t===J&&s!==J||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==J&&(s===J||i);i&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class at{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Y(this,t)}}const ot=w.litHtmlPolyfillSupport;ot?.(Q,et),(w.litHtmlVersions??=[]).push("3.3.3");const lt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function kt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function At(t){return kt(t).filter(e=>Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function Ot(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function Ct(t,e){const s=Ot(t,e);return s?t.entities?.[s]?.device_id:void 0}function Et(t,e){if(!e)return[];const s=Ct(t,e);return function(t){return kt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!0;if(!s)return!1;const r=Ct(t,i),n=r?t.devices?.[r]:void 0;return n?.via_device_id===s})}function Pt(t,e){if(!t||!e)return"";const s=Ot(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,r=i?t.devices?.[i]:void 0;if(r)return r.name_by_user||r.name||"";const n=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return n?n[1]:""}const Nt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","VPD","mdi:water-opacity"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Rt=[["light_1","Light 1","mdi:lightbulb"],["light_2","Light 2","mdi:lightbulb"]],Dt=[["fan","Fan","mdi:fan"],["blower","Blower","mdi:weather-windy"]],Mt=[["heater","Heater","mdi:radiator"],["humidifier","Humidifier","mdi:air-humidifier"],["dehumidifier","Dehumidifier","mdi:air-humidifier-off"]],zt=[["Temperature","env_temp_day","env_temp_night","env_temp_deadband","mdi:thermometer"],["Humidity","env_humi_day","env_humi_night","env_humi_deadband","mdi:water-percent"],["CO2","env_co2_day","env_co2_night","env_co2_deadband","mdi:molecule-co2"]];class Tt extends ct{constructor(){super(...arguments),this.tab="overview",this.alertsDraft=null,this.soilOpen=null,this.soilAllOpen=!1,this.deviceOpen=null,this.draft={},this.modePick={},this.outletDraft={}}setConfig(t){if(!t.panel)throw new Error('spider-farmer-card: "panel" is required (e.g. panel: dp1)');this.config=t;const e=t.default_tab;this.tab="environment"===e||"config"===e?"env":"outlets"===e?"outlets":"calibration"===e||"cali"===e?"cali":"overview"}getCardSize(){return 8}static getConfigElement(){return document.createElement("spider-farmer-card-editor")}static getStubConfig(t){const e=(t?At(t):[])[0]||"dp1",s=t?Et(t,e):[];return{type:"custom:spider-farmer-card",panel:e,...s.length?{outlets:s}:{}}}eid(t,e){return`${t}.sf_${this.config.panel}_${e}`}get(t){return this.hass?.states[t]}accent(){return this.config.accent||gt}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("tab")||t.has("soilOpen")||t.has("soilAllOpen")||t.has("outletDraft")||t.has("alertsDraft")||t.has("deviceOpen")||t.has("draft")||t.has("modePick")}willUpdate(t){if(t.has("hass")&&Object.keys(this.modePick).length){let t=null;for(const[e,s]of Object.entries(this.modePick))this.get(e)?.state===s&&(t=t??{...this.modePick},delete t[e]);t&&(this.modePick=t)}}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return J;const r=i.attributes.unit_of_measurement||"",n=this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(r,"").trim():i.state,a=t.startsWith("soil_avg_")?t.slice(9):null,o=!!a&&this.soilProbeRows(a).length>1,l=o&&this.soilOpen===a;return I`
      ...
      </div>`}soilProbeRows(t){const e=new RegExp(`^sf_${this.config.panel}_(soil\\d+)_${t}$`),s=[];for(const i of Object.keys(this.hass?.states??{})){const r=bt(i).match(e);r&&s.push({slot:r[1],name:this.soilSensorName(i,t),e:this.hass.states[i]})}return s.sort((t,e)=>Number(t.slot.replace(/\D/g,""))-Number(e.slot.replace(/\D/g,""))),s.map(({name:t,e:e})=>({name:t,e:e}))}soilSensorName(t,e){let s=this.hass?.states[t]?.attributes.friendly_name??"";const i=Pt(this.hass,this.config.panel);i&&s.startsWith(i)&&(s=s.slice(i.length).trim());const r="temperature"===e?"Temperature":"moisture"===e?"Moisture":"EC";return s=s.replace(new RegExp(`\\s*${r}\\s*$`,"i"),"").trim(),s||bt(t)}renderSoilPop(){const t=this.soilOpen;if(!t)return J;const e=this.soilProbeRows(t);if(!e.length)return J;return I`
      <div class="soil-pop">
      ...
      ${e?I`
            ...
            </div>`:J}`}overviewDevices(){const t=[],e=(e,s)=>{for(const[i,r,n]of s){const s=this.eid(e,i);this.get(s)&&t.push({domain:e,suffix:i,id:s,label:r,icon:n})}};return e("light",Rt),e("fan",Dt),e("switch",Mt),t}deviceStateText(t,e){if("unavailable"===e.state||"unknown"===e.state)return"Offline";if("light"===t)return"on"!==e.state?"Off":`${Math.round((e.attributes.brightness??0)/255*100)}%`;if("fan"===t){if("on"!==e.state)return"Off";const t=Math.round(e.attributes.percentage??0);return t?`${t}%`:"On"}return"on"===e.state?"On":"Off"}deviceTile(t){const e=this.get(t.id);if(!e)return J;const s="on"===e.state,i=`${t.domain}:${t.suffix}`,r=this.deviceOpen===i,n=this.accent();return I`
      ...
      </div>`}relatedControls(t,e){const s=this.config.panel,i=new RegExp(`^(number|select|switch|text)\\.sf_${s}_${t}(_|$)`),r=`switch.sf_${s}_${t}`,n=`number.sf_${s}_${t}_speed`,a=Pt(this.hass,this.config.panel);return Object.keys(this.hass?.states??{}).filter(t=>i.test(t)&&t!==r&&!("fan"===e&&t===n)).sort().map(t=>{let e=this.hass?.states[t]?.attributes.friendly_name??"";return a&&e.startsWith(a)&&(e=e.slice(a.length).trim()),this.ctlRow(e||t,t)})}renderDevicePop(){const t=this.deviceOpen;if(!t)return J;const e=this.overviewDevices().find(e=>`${e.domain}:${e.suffix}`===t);if(!e)return J;const s=this.get(e.id);if(!s)return J;const i="light"===e.domain?this.renderLightBody(e,s):"fan"===e.suffix?this.renderFanBody(e,s):"heater"===e.suffix||"humidifier"===e.suffix||"dehumidifier"===e.suffix?this.renderClimateBody(e,s):this.renderGenericBody(e,s);return I`
      ...
      <div class="dev-row">
      ...
      </div>`}renderGenericBody(t,e){const s="on"===e.state,i=this.accent(),r="fan"===t.domain?"fan":"switch";let n=J;if("fan"===t.domain){const r=Math.round(e.attributes.percentage??0);n=I`
        <div class="dev-row">
        ...
        </div>`}return I`${this.powerRow(t.id,r,t.label,s)}${n}${this.relatedControls(t.suffix,t.domain)}`}renderClimateBody(t,e){const s=this.config.panel,i="on"===e.state,r=t.suffix,n="dehumidifier"===r?`select.sf_${s}_dehumidifier_level_set`:`number.sf_${s}_${r}_level_set`,a=`text.sf_${s}_${r}_apply`,o=[];return o.push(this.powerRow(t.id,"switch",t.label,i)),this.get(n)&&(o.push(this.stagedRow("Level",n)),o.push(this.saveBar(a,{[n]:"level"}))),o}textState(t){const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""}durMinutes(t,e){const s=t=>{const e=/^(\d{1,2}):(\d{2})/.exec(t);return e?60*Number(e[1])+Number(e[2]):null},i=s(this.textState(t)),r=s(this.textState(e));if(null==i||null==r)return null;let n=(r-i+1440)%1440;return 0===n&&(n=1440),n}durationText(t,e){const s=this.durMinutes(t,e);return null==s?null:`${Math.floor(s/60)}h ${String(s%60).padStart(2,"0")}min`}infoRow(t,e){return I`<div class="dev-row">
      <span class="dev-lbl">${t}</span><span class="dev-spacer"></span>
      <span class="dev-val">${e}</span>
    </div>`}ctlRow(t,e){const s=this.get(e);if(!s)return J;const i=e.split(".")[0];let r;return r="number"===i?this.numberControl(e,s):"select"===i?this.selectControl(e,s):"text"===i?this.textControl(e,s):"switch"===i?this.switchControl(e,s):I`<span class="ctl-val">${s.state}</span>`,I`<div class="dev-row">
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${r}</div>
    </div>`}renderLightBody(t,e){const s=this.config.panel,i=t.suffix,r=this.accent(),n="on"===e.state,a=`select.sf_${s}_${i}_mode`,o=this.get(a),l=this.modeOf(a),c=this.get(`sensor.sf_${s}_${i}_brightness`),d=this.get(`sensor.sf_${s}_ppfd`),p=c&&Number.isFinite(Number(c.state))?`${Math.round(Number(c.state))}%`:"—",h=d&&Number.isFinite(Number(d.state))?`${Math.round(Number(d.state))} µmol`:"—",u=`text.sf_${s}_${i}_apply`,f=`number.sf_${s}_${i}_go_dark`,g=`number.sf_${s}_${i}_turn_off`,m=[];if(o&&m.push(this.liveModeRow("Mode",a)),m.push(this.powerRow(t.id,"light",t.label,n)),"Manual"===l){const s=Math.round((e.attributes.brightness??0)/255*100);m.push(I`
        <div class="dev-row">
        ...
        </div>`)}else if("Time Slot"===o){const t={[n]:"mode",[`text.sf_${s}_fan_schedule_start`]:"schedule_start",[`text.sf_${s}_fan_schedule_stop`]:"schedule_end",[c]:"schedule_speed",[d]:"standby_speed"};v.push(this.stagedPeriodRow(`text.sf_${s}_fan_schedule_start`,`text.sf_${s}_fan_schedule_stop`,"Schedule")),v.push(h()),v.push(f()),v.push(g()),v.push(this.ctlRow("Natural Wind",p)),v.push(this.saveBar(m,t))}else if("Cycle"===o){const t=`text.sf_${s}_fan_cycle_start`,e=`text.sf_${s}_fan_cycle_run`,i=`text.sf_${s}_fan_cycle_off`,r=`number.sf_${s}_fan_cycle_times`,a={[n]:"mode",[t]:"cycle_start",[e]:"cycle_run",[i]:"cycle_off",[r]:"cycle_times",[c]:"schedule_speed",[d]:"standby_speed"};v.push(this.stagedRow("Start Time",t,"time")),v.push(this.stagedRow("Run Duration",e,"duration")),v.push(this.stagedRow("Off Duration",i,"duration")),v.push(this.stagedRow("Execution Times",r)),v.push(h()),v.push(f()),v.push(g()),v.push(this.ctlRow("Natural Wind",p)),v.push(this.saveBar(m,a))}else if("Environment"===o){const t=`select.sf_${s}_fan_run_mode`,e={[n]:"mode",[t]:"env_submode",[c]:"schedule_speed",[d]:"standby_speed"};v.push(this.stagedRow("Run Mode",t)),v.push(h()),v.push(f()),v.push(g()),v.push(this.ctlRow("Natural Wind",p)),v.push(this.saveBar(m,e))}return v}setBrightness(t,e){const s=Number(e.target.value);s<=0?this.hass?.callService("light","turn_off",{entity_id:t}):this.hass?.callService("light","turn_on",{entity_id:t,brightness_pct:s})}setPercent(t,e){const s=Number(e.target.value);this.hass?.callService("fan","set_percentage",{entity_id:t,percentage:s})}renderOverview(){const t=Nt.map(t=>this.renderParam(t)).filter(t=>t!==J),e=this.overviewDevices();return I`
      ${t.length?I`<div class="section-label">Parameters</div>
            <div class="grid">${t}</div>
            ${this.renderSoilPop()}`:J}
      ${this.renderSoilAll()}
      ${e.length?I`<div class="section-label">Devices</div>
            <div class="grid">${e.map(t=>this.deviceTile(t))}</div>
            ${this.renderDevicePop()}`:J}`}renderControl(t,e){const s=this.get(t);if(!s)return J;const i=t.split(".")[0],r=e??s.attributes.friendly_name??t.split(".")[1];let n;return n="number"===i?this.numberControl(t,s):"select"===i?this.selectControl(t,s):"text"===i?this.textControl(t,s):"switch"===i?this.switchControl(t,s):I`<span class="ctl-val">${s.state}</span>`,I`
      <div class="ctl">
        <div class="ctl-label">${r}</div>
        <div class="ctl-input">${n}</div>
      </div>`}numberControl(t,e){const s=e.attributes.min??0,i=e.attributes.max??100,r=e.attributes.step??1,n=e.attributes.unit_of_measurement??"",a="slider"===e.attributes.mode,o=yt(e.state,r);return a?I`
      ...
      </span>`}sliderBoxControl(t,e){const s=e.attributes.min??0,i=e.attributes.max??100,r=e.attributes.step??1,n=e.attributes.unit_of_measurement??"",a=yt(e.state,r);return I`
      <div class="slider-box">
        <span class="sl-live">
          <input type="range" min=${s} max=${i} step=${r}
            .value=${a} style="accent-color:${this.accent()}" data-unit=${n}
            @input=${wt}
            @change=${e=>this.setNumber(t,e)} />
          <span class="sl-bub"></span>
        </span>
      ...
      </div>`}selectControl(t,e){const s=e.attributes.options??[];return I`
      ...
      </select>`}const n="time"===e||"duration"===e||/^\d{1,2}:\d{2}/.test(r);return I`<input type=${n?"time":"text"}
      step=${"duration"===e?"1":J} .value=${r}
      @change=${e=>this.stage(t,e.target.value)} />`}numOpts(t,e,s=1,i=String){const r=[];for(let n=t;n<=e;n+=s)r.push({label:i(n),value:String(n)});return r}offOpts(t,e,s=1,i){return[{label:"Off",value:"0"},...this.numOpts(t,e,s,i)]}optSelect(t,e,s=!1){if(!this.get(t))return J;const i=this.draftVal(t),r=e.find(t=>Number(t.value)===Number(i))?.value??e.find(t=>t.value===i)?.value??i;return I`<select .value=${String(r)} @change=${e=>{const i=e.target.value;s?this.hass?.callService("number","set_value",{entity_id:t,value:Number(i)}):this.stage(t,i)}}>
      ${e.map(t=>I`<option value=${t.value}>${t.label}</option>`)}
    </select>`}optSelectRow(t,e,s,i=!1){if(!this.get(e))return J;const r=!i&&e in this.draft?"dev-row staged":"dev-row";return I`<div class=${r}>
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${this.optSelect(e,s,i)}</div>
    </div>`}stagedRow(t,e,s){if(!this.get(e))return J;const i=e in this.draft?"dev-row staged":"dev-row";return I`<div class=${i}>
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${this.stagedInput(e,s)}</div>
    </div>`}stagedPeriodRow(t,e,s){const i=this.get(t),r=this.get(e);if(!i&&!r)return J;const n=t in this.draft||e in this.draft;return I`<div class="dev-row period-row ${n?"staged":""}">
      <span class="dev-lbl">${s}</span>
      <div class="period-times">
        ${i?this.stagedInput(t,"time"):J}
        <span class="dash">–</span>
        ${r?this.stagedInput(e,"time"):J}
      </div>
    </div>`}liveModeRow(t,e){const s=this.get(e);if(!s)return J;const i=s.attributes.options??[];return I`<div class="dev-row">
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">
        ...
        <div class="sched-actions">
          ...
          ${i?I`<button class="discard" @click=${()=>this.clearOutletDraft(t,e)}>Discard</button>
                <button class="save" style="background:${r}"
                  @click=${()=>this.saveOutlet(t,e)}>Save</button>`:J}
        </div>
      </div>`}caliSoilSlots(){const t=new RegExp(`^sf_${this.config.panel}_(soil\\d+)_cal_temp$`),e=new Set;for(const s of Object.keys(this.hass?.states??{})){const i=bt(s).match(t);i&&e.add(i[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}hasCali(){return!!this.get(`number.sf_${this.config.panel}_cal_air_temp`)||this.caliSoilSlots().length>0}probeName(t){const e=this.get(`number.sf_${this.config.panel}_${t}_cal_temp`);let s=e?.attributes.friendly_name??"";const i=Pt(this.hass,this.config.panel);return i&&s.startsWith(i)&&(s=s.slice(i.length).trim()),s=s.replace(/\s*Temp Calibration\s*$/i,"").trim(),s||t.replace(/^soil(\d+)$/,"Soil $1")}renderCali(){const t=this.config.panel,e=[[`number.sf_${t}_cal_air_temp`,"Air Temp"],[`number.sf_${t}_cal_air_humidity`,"Air Humidity"],[`number.sf_${t}_cal_ppfd`,"PPFD"],[`number.sf_${t}_cal_co2`,"CO2"]].map(([t,e])=>{const s=this.get(t);return s?I`
          <div class="ctl">
            <div class="ctl-label">${e}</div>
            <div class="ctl-input">${this.sliderBoxControl(t,s)}</div>
          </div>`:J}).filter(t=>t!==J),s=this.caliSoilSlots().map(e=>{const s=[this.renderControl(`number.sf_${t}_${e}_cal_temp`,"Temp"),this.renderControl(`number.sf_${t}_${e}_cal_moisture`,"Moisture"),this.renderControl(`number.sf_${t}_${e}_cal_ec`,"EC")].filter(t=>t!==J),i=this.renderControl(`select.sf_${t}_${e}_substrate`,"Substrate");return I`
        <div class="env-row">
          <div class="env-row-head">
      ...
      ${i.map((t,s)=>this.renderAlertMetric(e,s,t))}`:J}renderAlertMetric(t,e,s){const i=this.accent(),r=(i,r)=>I`
      <label class="av">
        <span class="av-lbl">${i}</span>
        <span class="num-box">
          <input type="number" step=${s.step??1} .value=${String(s[r]??"")}
      ...
      </div>`}renderAlertOther(t){const e=t.other||[];if(!e.length)return J;const s=this.accent();return I`
      ...
      ${e.map((t,e)=>I`<div class="alert-bool">
        ...
        </div>`)}`}render(){if(!this.hass||!this.config)return J;const t=this.hasEnv(),e=this.hasOutlets(),s=this.hasCali(),i=this.hasAlerts();let r=this.tab;"env"!==r||t||(r="overview"),"outlets"!==r||e||(r="overview"),"cali"!==r||s||(r="overview"),"alerts"!==r||i||(r="overview");const n=t||e||s||i,a=this.accent(),o=(t,e)=>I`<button class="tab ${r===t?"active":""}"
        style=${r===t?`color:${a};border-color:${a}`:""}
        @click=${()=>this.tab=t}>${e}</button>`,l=Pt(this.hass,this.config.panel);return I`
      <ha-card>
        <div class="header">
          <span class="title">${this.config.title||"Spider Farmer"}</span>
          ${l?I`<span class="device">${l}</span>`:J}
        </div>
        ${n?I`<div class="tabs">
              ${o("overview","Overview")}
  ...
  `,t([ut({attribute:!1})],Ft.prototype,"hass",void 0),t([ft()],Ft.prototype,"_config",void 0);const jt=/^sf_(se\d+)_light$/;function Ut(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(jt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Bt extends ct{constructor(){super(...arguments),this.draft=null}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Ut(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||gt}seSlot(){return this.config.light||(this.hass?Ut(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")}setBrightness(t){const e=`light.sf_${this.seSlot()}_light`;t<=0?this.hass?.callService("light","turn_off",{entity_id:e}):this.hass?.callService("light","turn_on",{entity_id:e,brightness_pct:t})}toggle(){this.hass?.callService("light","toggle",{entity_id:`light.sf_${this.seSlot()}_light`})}setMode(t){this.hass?.callService("select","select_option",{entity_id:`select.sf_${this.seSlot()}_mode`,option:t})}render(){if(!this.hass||!this.config)return J;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return I`<ha-card>
        <div class="empty">
          No Spider Farmer SE light found${this.config.light?` for "${this.config.light}"`:""}.
        </div>
      </ha-card>`;const s="on"===e.state,i=s?Math.max(0,Math.min(100,Math.round((e.attributes.brightness??0)/255*100))):0,r=this.get(`select.sf_${t}_mode`),n=r?.state??"",a=Pt(this.hass,t),o=this.accent(),l=i/100,[c,d]=$t(100,100,78,135+270*l);return I`
      <ha-card>
        <div class="header">
          <span class="title">${this.config.title||"Spider Light"}</span>
          ${a?I`<span class="device">${a}</span>`:J}
        </div>
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${s&&l>0?V`<path d=${_t(100,100,78,0,l)} fill="none"
                  stroke-linecap="round" stroke=${o} stroke-width="15"></path>`:J}
            ${s?V`<circle cx=${c.toFixed(2)} cy=${d.toFixed(2)} r="10"
                  fill="#fff" stroke=${o} stroke-width="3"></circle>`:J}
      ...
      ${r?this.numRow(`number.sf_${t}_sunrise_sunset_fade`,"Sunrise / sunset fade",r):J}`:J}timeField(t,e){const s=this.get(t);if(!s)return J;const i="unknown"===s.state||"unavailable"===s.state?"":s.state;return I`<div class="tf">
    ...
    </div>`}numRow(t,e,s){const i=s.attributes.min??0,r=s.attributes.max??100,n=s.attributes.step??1,a=s.attributes.unit_of_measurement??"",o="unknown"===s.state||"unavailable"===s.state?"":s.state;return I`<div class="num-row">
    ...
    .save { color: #fff; }
    .discard { background: var(--secondary-background-color); color: var(--primary-text-color); }
  `,t([ut({attribute:!1})],Bt.prototype,"hass",void 0),t([ft()],Bt.prototype,"config",void 0),t([ft()],Bt.prototype,"draft",void 0),customElements.get("spider-farmer-card")||customElements.define("spider-farmer-card",Tt),customElements.get("spider-farmer-card-editor")||customElements.define("spider-farmer-card-editor",Ft),customElements.get("spider-light-card")||customElements.define("spider-light-card",Bt),window.customCards=window.customCards||[],window.customCards.push({type:"spider-farmer-card",name:"Spider Farmer Card",description:"Tent overview + config for the Spider Farmer Bridge integration",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),window.customCards.push({type:"spider-light-card",name:"Spider Light Card",description:"Brightness dial, mode, and schedule for a Spider Farmer SE-series light",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),console.info("%c SPIDER-FARMER-CARD %c v0.16.9 ","color:#fff;background:#ff7a1a;border-radius:3px 0 0 3px;padding:2px 4px","color:#ff7a1a;background:#222;border-radius:0 3px 3px 0;padding:2px 4px");export{Tt as SpiderFarmerCard,Ft as SpiderFarmerCardEditor,Bt as SpiderLightCard};
